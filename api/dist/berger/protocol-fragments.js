...
exports.HEARTBEAT = exports.ENCRYPTION_KEY_REQUIRED = exports.CONNECT = void 0;
const CONNECT = (bridgeAddress) => {
    return {
        type: 'BridgeEvent',
        json_payload: {
            ncp_version: '0x46C5',
...
const ENCRYPTION_KEY_REQUIRED = (bridgeAddress, deviceAddress) => {
    return {
...
exports.ENCRYPTION_KEY_REQUIRED = ENCRYPTION_KEY_REQUIRED;
const HEARTBEAT = (bridgeAddress, deviceAddress) => {
    return {
        rssi_stats: [-20, -20, -19],
        device_address: deviceAddress,
